...
https://github.com/akatsuki/ImagePadServer/releases/tag/v1.5.8

## まず使う

Windows では GitHub Release から `imagepadserver-v1.5.8-windows-amd64.zip` をダウンロードして展開し、exe を起動します。
