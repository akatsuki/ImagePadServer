...
const dashboardScriptDomRefs = `
    ...
    const airplayModeButton = document.getElementById('airplayModeButton');
    const playlistInputTabs = document.getElementById('playlistInputTabs');
    const playlistFileModeButton = document.getElementById('playlistFileModeButton');
    const playlistLinkModeButton = document.getElementById('playlistLinkModeButton');
    ...
    const liveIntentButton = document.getElementById('liveIntentButton');
    const mediaNavParentButtons = Array.from(document.querySelectorAll('[data-media-nav-parent]'));
    ...
    const airplayUploadPanel = document.getElementById('airplayUploadPanel');
    ...
    const niconicoCommentsOption = document.getElementById('niconicoCommentsOption');
    const niconicoCommentsEnabled = document.getElementById('niconicoCommentsEnabled');
    const niconicoCommentsHint = document.getElementById('niconicoCommentsHint');
    ...
    const ytdlpChannelSelect = document.getElementById('ytdlpChannelSelect');
    const ytdlpChannelStatus = document.getElementById('ytdlpChannelStatus');
