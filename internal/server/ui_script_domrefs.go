...
const dashboardScriptDomRefs = `
    ...
    const plFileButton = document.getElementById('plFileButton');
    const plAddButton = document.getElementById('plAddButton');
    const plPlayNowButton = document.getElementById('plPlayNowButton');
    const plTrackTableBody = document.getElementById('plTrackTableBody');
