    ...
    <div class="preview-column">
      ...
      <section class="hero-panel music-playlist-panel" id="musicPlaylistPanel" hidden aria-label="プレイリスト">
        <div class="section-head">
          <div class="section-title-copy">
            <h2>プレイリスト</h2>
            <p class="section-kicker">再生状態、曲順、配信URLをここで管理する</p>
          </div>
          <div class="pl-saved-menu-wrap">
            <button type="button" class="secondary icon-button pl-menu-button" id="plMenuButton" aria-haspopup="menu" aria-expanded="false" title="プレイリストの保存と読み込み" aria-label="プレイリストの保存と読み込み">
        ...
        <div class="pl-body">
          <div class="pl-player-row">
            ...
            <div class="pl-player-main">
              ...
              <div class="pl-controls" role="group" aria-label="再生操作">
                ...
                <button type="button" class="pl-stream-start" id="plStartStreamButton" aria-label="配信開始">
                  <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M6 18.5a8 8 0 1 1 12 0M9 15.5a4 4 0 1 1 6 0"/><circle cx="12" cy="18" r="2" fill="currentColor"/></svg>
                  <span>配信開始</span>
                </button>
              </div>
            </div>
          ...
          <div class="pl-list" id="plTrackList" aria-label="プレイリストの曲一覧">
            <div class="pl-list-empty">曲がありません。左のアップロードから追加してください</div>
          </div>
          <div class="pl-count" id="plTrackCount">0 曲</div>
        </div>
      </section>
    </div>
